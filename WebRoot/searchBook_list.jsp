					...
					<table cellspacing="0" class="listcontent">
						<tr>
							<td>
								<h1>商品目录</h1>
								<hr />
								<h1>与“${pb.name==""?"全部":pb.name }”相关的</h1>&nbsp;&nbsp;&nbsp;&nbsp;共${pb.count}种商品
								<hr />
								...
								<div class="pagination">
									<ul>
										...
										<li class="nextPage"><a
											href="${pageContext.request.contextPath  }/searchBooksByName?currentPage=${pb.currentPage==1?1:pb.currentPage-1}&name=${pb.name}">&lt;&lt;上一页</a>
										</li>
										...
										<li class="nextPage"><a
											href="${pageContext.request.contextPath  }/searchBooksByName?currentPage=${pb.currentPage==pb.totalPage?pb.totalPage:pb.currentPage+1}&name=${pb.name}">下一页&gt;&gt;</a>
										</li>
